...
const PRODUCTS_LIST = [
  ...
  "7 Feet 48 Blade Multi Speed Rotavator",
  "Reverse Forward Tiller Rotavator",
  "Rotavator Side Disk",
  "Rotavator PTO Shaft",
  "Rotavator Blade",
  "Blade Bolt Nut",
  "9 Tine Cultivator 2 1/4 Safe 3 Feet Arm Cultivator",
  "5 Tine Duck Feet Cultivator",
  "Gauge Wheels",
  "Spring Cultivator 9 Arm",
  "Spring Cultivator 9 Arm (Bush Type)",
  "Other",
];
